						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i><?= $company_address ?></a></li>
									<li><a href="#"><i class="fa fa-phone"></i><?= $company_number ?></a></li>
									<li><a href="#"><i class="fa fa-envelope-o"></i><?= $company_email ?></a></li>
								</ul>
							</div>
						</div>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-12 text-center">
							<ul class="footer-payments" style="display: none;">
